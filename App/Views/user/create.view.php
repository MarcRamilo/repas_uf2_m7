...
<form action="/user/store" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="mail" class="form-control" name="mail" id="mail" aria-describedby="helpId" placeholder="" value="<?php echo $_POST['mail']?? null ?>" />
    </div>
    <div class="mb-3">
        <label for="date" class="form-label">Birthdate </label>
        <input type="date" class="form-control" name="date" id="date" aria-describedby="helpId" placeholder="" value="<?php echo $_POST['date']?? null ?>" />
    </div>
    <div class="mb-3">
        <label for="profile_image" class="form-label">Profile Image</label>
        <input type="file" class="form-control" name="profile_image" id="profile_image" aria-describedby="helpId" placeholder="" value="<?php echo $_POST['profile_image']?? null ?>" />
    </div>
    <div class="mb-3">
